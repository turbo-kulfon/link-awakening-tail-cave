...
import com.la.aspects.wall_bounce.half_wall_corner.RightUpCornerHalfWallResponseCallback;

public class RightUpHalfWall implements IGameObject {
	...
	public RightUpHalfWall(
		...
		spatialComponent.setCollisionResponse(new RightUpCornerHalfWallResponseCallback(spatialComponent, aspectSystem));
