...
public class HorizontalHalfWallDownSegment implements IGameObject {
	...
	public HorizontalHalfWallDownSegment(
		...
		drawComponent.setSpriteOffsetY(-8);

		spatialComponent = spatialSystem.createStaticComponent(uniqueID);
		spatialComponent.setCoordinates(x, y + 8, 16, 8);
