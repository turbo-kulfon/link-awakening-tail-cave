...
import com.la.aspects.wall_bounce.half_wall_corner.LeftDownCornerHalfWallResponseCallback;

public class LeftDownHalfWall implements IGameObject {
	...
	public LeftDownHalfWall(
		...
		spatialComponent.setCollisionResponse(new LeftDownCornerHalfWallResponseCallback(spatialComponent, aspectSystem));
