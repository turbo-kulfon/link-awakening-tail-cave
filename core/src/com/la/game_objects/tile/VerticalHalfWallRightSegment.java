...
public class VerticalHalfWallRightSegment implements IGameObject {
	...
	public VerticalHalfWallRightSegment(
		...
		drawComponent.setSpriteOffsetX(-8);

		spatialComponent = spatialSystem.createStaticComponent(uniqueID);
		spatialComponent.setCoordinates(x + 8, y, 8, 16);
