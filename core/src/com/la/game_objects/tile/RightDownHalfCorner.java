...
public class RightDownHalfCorner implements IGameObject {
	...
	public RightDownHalfCorner(
		...
		drawComponent.setSpriteOffset(-8, -8);

		spatialComponent = spatialSystem.createStaticComponent(uniqueID);
		spatialComponent.setCoordinates(x + 8, y + 8, 8, 8);
