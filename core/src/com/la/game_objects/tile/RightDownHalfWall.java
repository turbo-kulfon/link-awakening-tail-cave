...
import com.la.aspects.wall_bounce.half_wall_corner.RightDownCornerHalfWallResponseCallback;

public class RightDownHalfWall implements IGameObject {
	...
	public RightDownHalfWall(
		...
		spatialComponent.setCollisionResponse(new RightDownCornerHalfWallResponseCallback(spatialComponent, aspectSystem));
