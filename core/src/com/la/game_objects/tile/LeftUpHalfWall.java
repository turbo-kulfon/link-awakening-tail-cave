...
import com.la.aspects.wall_bounce.half_wall_corner.LeftUpCornerHalfWallResponseCallback;

public class LeftUpHalfWall implements IGameObject {
	...
	public LeftUpHalfWall(
		...
		spatialComponent.setCollisionResponse(new LeftUpCornerHalfWallResponseCallback(spatialComponent, aspectSystem));
