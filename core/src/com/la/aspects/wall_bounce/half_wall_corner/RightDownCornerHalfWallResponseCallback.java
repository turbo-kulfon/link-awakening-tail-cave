...
public class RightDownCornerHalfWallResponseCallback implements ResponseCallback {
	private IAspectSystem aspectSystem;
	private ISpatialComponent spatialComponent;

	public RightDownCornerHalfWallResponseCallback(
	...
	public void response(int collidedID) {
		...
		if(wallBounce != null) {
			wallBounce.subPartBounce(
				spatialComponent.getX() + 8, spatialComponent.getY(),
				8, 16);
			wallBounce.subPartBounce(
